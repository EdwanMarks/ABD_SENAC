...
CREATE TABLE IF NOT EXISTS TELEFONE(
    ...
    CONSTRAINT FK_TELEFONE_TO_CLIENTE FOREIGN KEY(ID_CLIENTE)
	REFERENCES CLIENTE(ID_CLIENTE),
	 
	CONSTRAINT FK_TELEFONE_TO_FUNCIONARIO FOREIGN KEY(ID_FUNCIONARIO)
	REFERENCES FUNCIONARIO(ID_FUNCIONARIO),
	 
	CONSTRAINT FK_TELEFONE_TO_FORNECEDOR  FOREIGN KEY(ID_FORNECEDOR)
...
CREATE TABLE IF NOT EXISTS EMAIL(
    ...
    CONSTRAINT FK_EMAIL_TO_CLIENTE FOREIGN KEY(ID_CLIENTE)
	REFERENCES CLIENTE(ID_CLIENTE),
	 
	CONSTRAINT FK_EMAIL_TO_FUNCIONARIO FOREIGN KEY(ID_FUNCIONARIO)
	REFERENCES FUNCIONARIO(ID_FUNCIONARIO),
	 
	CONSTRAINT FK_EMAIL_TO_FORNECEDOR FOREIGN KEY(ID_FORNECEDOR)
	REFERENCES FORNECEDOR(ID_FORNECEDOR)
);
...
CREATE TABLE IF NOT EXISTS INSTAGRAM(
    ...
    CONSTRAINT FK_INSTAGRAM_TO_CLIENTE FOREIGN KEY(ID_CLIENTE)
	REFERENCES CLIENTE(ID_CLIENTE)
);
...
CREATE TABLE IF NOT EXISTS ESTADO(
	...
	CONSTRAINT FK_ESTADO_TO_PAIS FOREIGN KEY(ID_PAIS)
...
CREATE TABLE IF NOT EXISTS CIDADE(
	...
	CONSTRAINT FK_CIDADE_TO_BAIRRO FOREIGN KEY(ID_PAIS)
	REFERENCES PAIS(ID_PAIS),
    
    CONSTRAINT FK_CIDADE_TO_ESTADO FOREIGN KEY(ID_ESTADO)
...
CREATE TABLE IF NOT EXISTS BAIRRO(
	...
	CONSTRAINT FK_BAIRRO_TO_PAIS FOREIGN KEY(ID_PAIS)
	REFERENCES PAIS(ID_PAIS),
    
    CONSTRAINT FK_BAIRRO_TO_ESTADO FOREIGN KEY(ID_ESTADO)
	REFERENCES ESTADO(ID_ESTADO),
    
    CONSTRAINT FK_BAIRRO_TO_CIDADE FOREIGN KEY(ID_CIDADE)
...
CREATE TABLE IF NOT EXISTS LISTA_PONTO(
	 ...
	 CONSTRAINT FK_LISTA_PONTO_TO_FUNCIONARIO FOREIGN KEY(ID_FUNCIONARIO)
	 REFERENCES FUNCIONARIO(ID_FUNCIONARIO)
     );
...
CREATE TABLE IF NOT EXISTS PEDIDO(
    ...
    CONSTRAINT FK_PEDIDO_TO_CLIENTE FOREIGN KEY(ID_CLIENTE)
	REFERENCES CLIENTE(ID_CLIENTE),
     
    CONSTRAINT FK_PEDIDO_TO_FUNCIONARIO FOREIGN KEY(ID_FUNCIONARIO)
	REFERENCES FUNCIONARIO(ID_FUNCIONARIO) 
);
...
CREATE TABLE IF NOT EXISTS PAGAMENTO(
    ...
    CONSTRAINT FK_PAGAMENTO_TO_PEDIDO FOREIGN KEY(ID_PEDIDO)
...
CREATE TABLE IF NOT EXISTS ITEM_MENU(
    ...
    CONSTRAINT FK_ITEM_MENU_TO_CATEGORIA FOREIGN KEY(ID_CATEGORIA)
...
CREATE TABLE IF NOT EXISTS ORDEM_COMPRA(
    ...
    CONSTRAINT FK_ORDEM_COMPRA_TO_FUNCIONARIO FOREIGN KEY(ID_FUNCIONARIO)
	REFERENCES FUNCIONARIO(ID_FUNCIONARIO),

    CONSTRAINT FK_ORDEM_COMPRA_TO_FORNECEDOR FOREIGN KEY(ID_FORNECEDOR)
	REFERENCES FORNECEDOR(ID_FORNECEDOR)
);
...
CREATE TABLE IF NOT EXISTS ENDERECO(
	 ...
	 CONSTRAINT FK_ENDERECO_TO_FUNCIONARIO FOREIGN KEY(ID_FUNCIONARIO)
	 REFERENCES FUNCIONARIO(ID_FUNCIONARIO),
	 
	 CONSTRAINT FK_ENDERECO_TO_CLIENTE FOREIGN KEY(ID_CLIENTE)
	 REFERENCES CLIENTE(ID_CLIENTE),
     
     CONSTRAINT FK_ENDERECO_TO_FORNECEDOR FOREIGN KEY(ID_FORNECEDOR)
	 REFERENCES FORNECEDOR(ID_FORNECEDOR),
	...
	CONSTRAINT FK_ENDERECO_TO_PAIS FOREIGN KEY(ID_PAIS)
	REFERENCES PAIS(ID_PAIS),
    
    CONSTRAINT FK_ENDERECO_TO_ESTADO FOREIGN KEY(ID_ESTADO)
	REFERENCES ESTADO(ID_ESTADO),
    
    CONSTRAINT FK_ENDERECO_TO_CIDADE FOREIGN KEY(ID_CIDADE)
	REFERENCES CIDADE(ID_CIDADE),
    
    CONSTRAINT FK_ENDERECO_TO_BAIRRO FOREIGN KEY(ID_BAIRRO)
...
CREATE TABLE IF NOT EXISTS LISTA_PRODUTOS_COMPRA(
    ...
    CONSTRAINT FK_PRODUTOS_COMPRA_TO_ORDEM_COMPRA FOREIGN KEY(ID_ORDEM_COMPRA)
	REFERENCES ORDEM_COMPRA(ID_ORDEM_COMPRA),
    
    CONSTRAINT FK_PRODUTOS_COMPRA_TO_MATERIA_PRIMA FOREIGN KEY(ID_MATERIA_PRIMA)
...
CREATE TABLE IF NOT EXISTS DEMANDA(
    ...
    CONSTRAINT FK_DEMANDA_TO_ITEM_MENU FOREIGN KEY(ID_ITEM_MENU)
	REFERENCES ITEM_MENU(ID_ITEM_MENU),
    
    CONSTRAINT FK_DEMANDA_TO_MATERIA_PRIMA FOREIGN KEY(ID_MATERIA_PRIMA)
	REFERENCES MATERIA_PRIMA(ID_MATERIA_PRIMA)
);
...
CREATE TABLE IF NOT EXISTS ENTREGA(
    ...
    CONSTRAINT FK_ENTREGA_TO_FUNCIONARIO FOREIGN KEY(ID_FUNCIONARIO)
	REFERENCES FUNCIONARIO(ID_FUNCIONARIO),
    
    CONSTRAINT FK_ENTREGA_TO_PEDIDO FOREIGN KEY(ID_PEDIDO)
	REFERENCES PEDIDO(ID_PEDIDO),
    
    CONSTRAINT FK_ENTREGA_TO_MOTO FOREIGN KEY(ID_MOTO)
	REFERENCES MOTO(ID_MOTO),

    CONSTRAINT FK_ENTREGA_TO_ENDERECO FOREIGN KEY(ID_ENDERECO)
